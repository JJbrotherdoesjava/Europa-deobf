...
extends Element {
    ...
    public void onRender2D(EventRender2D eventRender2D) {
        ...
        if (direction.getValue().equals((Object)Directions.Normal)) {
            Europa.FONT_MANAGER.drawString(this.getDirectionName() + " " + firstSymbol.getValue() + this.getColor() + this.getFacing(ElementCoordinates.mc.player.getHorizontalFacing().getName()) + ChatFormatting.RESET + secondSymbol.getValue(), this.frame.getX(), this.frame.getY() - (float)(chatMove.getValue() && ElementCoordinates.mc.currentScreen instanceof GuiChat ? 11 : 0), ModuleColor.getActualColor());
        }
