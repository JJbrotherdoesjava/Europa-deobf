...
extends Module {
    ...
    public void onReceive(EventPacket.Receive receive) {
        block0: {
            ...
            void event;
            if (!(event.getPacket() instanceof SPacketSoundEffect) || !(packet = (SPacketSoundEffect)event.getPacket()).getSound().equals(SoundEvents.ENTITY_BOBBER_SPLASH)) break block0;
            new Thread(this){
