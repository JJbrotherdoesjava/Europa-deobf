...
extends Module {
     ...
     * WARNING - void declaration
     */
    public void lambda$onRender2D$9(Color color, Color color2, int[] nArray, Color color3, ScaledResolution scaledResolution, Module module) {
        void scaledRes;
        void color4;
        void mods;
        void color22;
        ...
        if (colorMode.getValue().equals((Object)colorModes.Rainbow)) {
            this.drawStringWithShadow("\u00a7+" + m.getTag() + "\u00a7r" + ChatFormatting.GRAY + m.getHudInfo(), (float)(scaledRes.getScaledWidth() - 2) - this.getStringWidth(string), scaledRes.getScaledHeight() + mods[0] * -10 - 12, colorMode.getValue().equals((Object)colorModes.Static) ? this.colorHud.getRGB() : (colorMode.getValue().equals((Object)colorModes.Wave) ? waveColor.getRGB() : gradientColor.getRGB()));
        } else {
     ...
     * WARNING - void declaration
     */
    public void lambda$onRender2D$7(Color color, Color color2, int[] nArray, Color color3, ScaledResolution scaledResolution, Module module) {
        void scaledRes;
        void color4;
        void mods;
        void color22;
     ...
     * WARNING - void declaration
     */
    public void lambda$onRender2D$5(Color color, Color color2, Color color3, ScaledResolution scaledResolution, int[] nArray, PotionEffect potionEffect) {
        void potCount;
        void scaledRes;
        void effect;
        void color4;
        ...
        String s = name + " " + amplifier + this.getInfoColor() + " " + (int)duration / 60 + ":" + seconds;
        String sR = "\u00a7+" + name + " " + amplifier + "\u00a7r" + this.getInfoColor() + " " + (int)duration / 60 + ":" + seconds;
        if (colorMode.getValue().equals((Object)colorModes.Rainbow)) {
     ...
     * WARNING - void declaration
     */
    public void lambda$onRender2D$4(Color color, Color color2, int[] nArray, Color color3, ScaledResolution scaledResolution, Module module) {
        void scaledRes;
        void color4;
        void mods;
        void color22;
     ...
     * WARNING - void declaration
     */
    public void lambda$onRender2D$2(Color color, Color color2, int[] nArray, Color color3, ScaledResolution scaledResolution, Module module) {
        void scaledRes;
        void color4;
        void mods;
        void color22;
     ...
     * WARNING - void declaration
     */
    public void lambda$onRender2D$0(Color color, Color color2, Color color3, ScaledResolution scaledResolution, int[] nArray, PotionEffect potionEffect) {
        void potCount;
        void scaledRes;
        void effect;
        void color4;
