...
public class ChatManager {
    ...
    public static void printChatNotifyClient(String string) {
        ...
        if (ModuleColor.prefixMode.getValue().equals((Object)ModuleColor.prefixModes.Rainbow) || ModuleColor.prefixMode.getValue().equals((Object)ModuleColor.prefixModes.Gradient)) {
            INSTANCE.printChatMessage((ModuleColor.prefix.getValue() ? "\u00a7+" + ChatFormatting.GRAY + " [" + ModuleColor.getTextColor() + "Europa" + ChatFormatting.GRAY + "] " : "") + "\u00a7r" + ChatFormatting.RESET + message);
        } else {
            INSTANCE.printChatMessage((ModuleColor.prefix.getValue() ? ChatFormatting.GRAY + " [" + ModuleColor.getTextColor() + "Europa" + ChatFormatting.GRAY + "] " : "") + ChatFormatting.RESET + message);
        }
    }
    ...
    public static void sendClientMessage(String string, int n) {
        ...
        TextComponentString component = ModuleColor.prefixMode.getValue().equals((Object)ModuleColor.prefixModes.Rainbow) || ModuleColor.prefixMode.getValue().equals((Object)ModuleColor.prefixModes.Gradient) ? new TextComponentString((ModuleColor.prefix.getValue() ? "\u00a7+" + ChatFormatting.GRAY + " [" + ModuleColor.getTextColor() + "Europa" + ChatFormatting.GRAY + "] " : "") + "\u00a7r" + ChatFormatting.RESET + string2) : new TextComponentString((ModuleColor.prefix.getValue() ? ModuleColor.getBracketColour() + " [" + ModuleColor.getTextColor() + "Europa" + ModuleColor.getBracketColour() + "] " : "") + ChatFormatting.RESET + string2);
