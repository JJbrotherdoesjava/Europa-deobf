...
implements IMinecraft {
    ...
    public static void placeBlock(BlockPos blockPos, boolean bl, boolean bl2) {
        for (EnumFacing enumFacing : EnumFacing.values()) {
            ...
            void packet;
            BlockPos blockPos2;
            if (BlockUtils.mc.world.getBlockState(blockPos2.offset(enumFacing)).getBlock().equals(Blocks.AIR) || BlockUtils.isIntercepted(blockPos2)) continue;
            if (packet != false) {
    ...
    public static BlockResistance getBlockResistance(BlockPos blockPos) {
        ...
        block8: {
            block7: {
                ...
                if (BlockUtils.mc.world.getBlockState(block).getBlock().equals(Blocks.OBSIDIAN) || BlockUtils.mc.world.getBlockState(block).getBlock().equals(Blocks.ANVIL) || BlockUtils.mc.world.getBlockState(block).getBlock().equals(Blocks.ENCHANTING_TABLE)) break block7;
                if (!BlockUtils.mc.world.getBlockState(block).getBlock().equals(Blocks.ENDER_CHEST)) break block8;
            }
