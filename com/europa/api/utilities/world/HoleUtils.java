...
implements IMinecraft {
    ...
    public static boolean isHole(BlockPos blockPos) {
        ...
        block4: {
            ...
            block5: {
                retVal = false;
                if (!HoleUtils.mc.world.getBlockState(pos).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(pos.up()).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(pos.up().up()).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(pos.down()).getBlock().equals(Blocks.BEDROCK) && !HoleUtils.mc.world.getBlockState(pos.down()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                if (HoleUtils.mc.world.getBlockState(pos.east()).getBlock().equals(Blocks.BEDROCK)) break block5;
                if (!HoleUtils.mc.world.getBlockState(pos.east()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
            }
        ...
        block4: {
            ...
            block6: {
                block5: {
                    ...
                    if (!HoleUtils.mc.world.getBlockState(pos).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(pos.up()).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(pos.down()).getBlock().equals(Blocks.BEDROCK) && !HoleUtils.mc.world.getBlockState(pos.down()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                    if (HoleUtils.mc.world.getBlockState(pos.east()).getBlock().equals(Blocks.BEDROCK)) break block5;
                    if (!HoleUtils.mc.world.getBlockState(pos.east()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                }
                if (!HoleUtils.mc.world.getBlockState(pos.west()).getBlock().equals(Blocks.BEDROCK) && !HoleUtils.mc.world.getBlockState(pos.west()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                if (HoleUtils.mc.world.getBlockState(pos.south()).getBlock().equals(Blocks.BEDROCK)) break block6;
                if (!HoleUtils.mc.world.getBlockState(pos.south()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
            }
            if (HoleUtils.mc.world.getBlockState(pos.north()).getBlock().equals(Blocks.BEDROCK) || HoleUtils.mc.world.getBlockState(pos.north()).getBlock().equals(Blocks.OBSIDIAN)) {
                retVal = true;
            }
        ...
        block4: {
            ...
            block6: {
                block5: {
                    ...
                    if (!HoleUtils.mc.world.getBlockState(pos).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(pos.up()).getBlock().equals(Blocks.AIR)) break block4;
                    if (HoleUtils.mc.world.getBlockState(pos.down()).getBlock().equals(Blocks.BEDROCK)) break block5;
                    if (!HoleUtils.mc.world.getBlockState(pos.down()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                }
                if (!HoleUtils.mc.world.getBlockState(pos.east()).getBlock().equals(Blocks.BEDROCK) && !HoleUtils.mc.world.getBlockState(pos.east()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                if (!HoleUtils.mc.world.getBlockState(pos.west()).getBlock().equals(Blocks.BEDROCK) && !HoleUtils.mc.world.getBlockState(pos.west()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
                if (HoleUtils.mc.world.getBlockState(pos.south()).getBlock().equals(Blocks.BEDROCK)) break block6;
                if (!HoleUtils.mc.world.getBlockState(pos.south()).getBlock().equals(Blocks.OBSIDIAN)) break block4;
            }
    ...
    public static boolean isDoubleBedrockHoleX(BlockPos blockPos) {
        BlockPos blockPos2;
        if (!HoleUtils.mc.world.getBlockState(blockPos2).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(1, 0, 0)).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(0, 1, 0)).getBlock().equals(Blocks.AIR) && !HoleUtils.mc.world.getBlockState(blockPos2.add(1, 1, 0)).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(0, 2, 0)).getBlock().equals(Blocks.AIR) && !HoleUtils.mc.world.getBlockState(blockPos2.add(1, 2, 0)).getBlock().equals(Blocks.AIR)) {
            return false;
        }
    ...
    public static boolean isDoubleBedrockHoleZ(BlockPos blockPos) {
        ...
        block5: {
            block3: {
                block4: {
                    if (!HoleUtils.mc.world.getBlockState(blockPos2).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(0, 0, 1)).getBlock().equals(Blocks.AIR)) break block3;
                    if (HoleUtils.mc.world.getBlockState(blockPos2.add(0, 1, 0)).getBlock().equals(Blocks.AIR)) break block4;
                    if (!HoleUtils.mc.world.getBlockState(blockPos2.add(0, 1, 1)).getBlock().equals(Blocks.AIR)) break block3;
                }
                if (HoleUtils.mc.world.getBlockState(blockPos2.add(0, 2, 0)).getBlock().equals(Blocks.AIR) || HoleUtils.mc.world.getBlockState(blockPos2.add(0, 2, 1)).getBlock().equals(Blocks.AIR)) break block5;
            }
            return false;
        }
    ...
    public static boolean isDoubleObsidianHoleX(BlockPos blockPos) {
        ...
        block5: {
            block3: {
                block4: {
                    if (!HoleUtils.mc.world.getBlockState(blockPos2).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(1, 0, 0)).getBlock().equals(Blocks.AIR)) break block3;
                    if (HoleUtils.mc.world.getBlockState(blockPos2.add(0, 1, 0)).getBlock().equals(Blocks.AIR)) break block4;
                    if (!HoleUtils.mc.world.getBlockState(blockPos2.add(1, 1, 0)).getBlock().equals(Blocks.AIR)) break block3;
                }
                if (HoleUtils.mc.world.getBlockState(blockPos2.add(0, 2, 0)).getBlock().equals(Blocks.AIR) || HoleUtils.mc.world.getBlockState(blockPos2.add(1, 2, 0)).getBlock().equals(Blocks.AIR)) break block5;
            }
            return false;
        }
        for (BlockPos blockPos22 : new BlockPos[]{blockPos2.add(2, 0, 0), blockPos2.add(1, 0, 1), blockPos2.add(1, 0, -1), blockPos2.add(-1, 0, 0), blockPos2.add(0, 0, 1), blockPos2.add(0, 0, -1), blockPos2.add(0, -1, 0), blockPos2.add(1, -1, 0)}) {
    ...
    public static boolean isDoubleObsidianHoleZ(BlockPos blockPos) {
        ...
        block4: {
            block3: {
                if (!HoleUtils.mc.world.getBlockState(blockPos2).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(0, 0, 1)).getBlock().equals(Blocks.AIR) || !HoleUtils.mc.world.getBlockState(blockPos2.add(0, 1, 0)).getBlock().equals(Blocks.AIR) && !HoleUtils.mc.world.getBlockState(blockPos2.add(0, 1, 1)).getBlock().equals(Blocks.AIR)) break block3;
                if (HoleUtils.mc.world.getBlockState(blockPos2.add(0, 2, 0)).getBlock().equals(Blocks.AIR)) break block4;
                if (HoleUtils.mc.world.getBlockState(blockPos2.add(0, 2, 1)).getBlock().equals(Blocks.AIR)) break block4;
            }
            return false;
        }
        for (BlockPos blockPos22 : new BlockPos[]{blockPos2.add(0, 0, 2), blockPos2.add(1, 0, 1), blockPos2.add(-1, 0, 1), blockPos2.add(0, 0, -1), blockPos2.add(1, 0, 0), blockPos2.add(-1, 0, 0), blockPos2.add(0, -1, 0), blockPos2.add(0, -1, 1)}) {
